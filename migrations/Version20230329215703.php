 ...
 */
final class Version20230329215703 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE pay_policy (id INT AUTO_INCREMENT NOT NULL, payment_place_id INT DEFAULT NULL, policy_id INT DEFAULT NULL, INDEX IDX_79E6CF594D60E071 (payment_place_id), INDEX IDX_79E6CF592D29E3C6 (policy_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE pay_policy_charge (pay_policy_id INT NOT NULL, charge_id INT NOT NULL, INDEX IDX_4B089EDB275CBA (pay_policy_id), INDEX IDX_4B089EDB55284914 (charge_id), PRIMARY KEY(pay_policy_id, charge_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
