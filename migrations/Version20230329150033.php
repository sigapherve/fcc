 ...
 */
final class Version20230329150033 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE contrainte (id INT AUTO_INCREMENT NOT NULL, description VARCHAR(255) DEFAULT NULL, longdescription LONGTEXT DEFAULT NULL, enforcedate DATE DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
