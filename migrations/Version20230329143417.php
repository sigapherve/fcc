 ...
 */
final class Version20230329143417 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE commande (id INT AUTO_INCREMENT NOT NULL, client_id INT DEFAULT NULL, deliverycountry_id INT DEFAULT NULL, date DATE DEFAULT NULL, INDEX IDX_F529939819EB6921 (client_id), INDEX IDX_F5299398F0D6D3FF (deliverycountry_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE commande ADD CONSTRAINT FK_F529939819EB6921 FOREIGN KEY (client_id) REFERENCES customer (id)');
        $this->addSql('ALTER TABLE commande ADD CONSTRAINT FK_F5299398F0D6D3FF FOREIGN KEY (deliverycountry_id) REFERENCES country (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE commande DROP FOREIGN KEY FK_F529939819EB6921');
        $this->addSql('ALTER TABLE commande DROP FOREIGN KEY FK_F5299398F0D6D3FF');
